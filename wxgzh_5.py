...
class wx_gzh(object):
    ...
    def __init__(self):
        ...
        self.offset = 0
        self.count = 0
        self.base_url = 'https://mp.weixin.qq.com/mp/profile_ext?action=getmsg&__biz=MzU0NjcwOTYzOQ==&f=json&offset={}&count=10&is_ok=1&scene=124&uin=NjY2Mzg5MDY0&key=1c8d0f39d00e87238725bf409b4949cdf9696d85386abf38dbe581739865d50d00231be8cf6a93fd569d2dd748efbce0027a39d26a0981624594f59406c26fcfd3cf62b9375d0cd4ce9f5d8f9ed22e3d&pass_ticket=5Zx%2F6KSKXNBH%2BaeYBg4b7bKsVQxXIMf%2BS8GiZKBneQiu9dtMJzUuN33ddCWWtnnf&wxtoken=&appmsg_token=1014_bNPm4Ix5rLaAV5fs4cChsL4REnY-SimigLQWSA~~&x5=0&f=json'
        self.cookie = 'rewardsn=; wxtokenkey=777; wxuin=666389064; devicetype=Windows10; version=62060833; lang=zh_CN; pass_ticket=5Zx/6KSKXNBH+aeYBg4b7bKsVQxXIMf+S8GiZKBneQiu9dtMJzUuN33ddCWWtnnf; wap_sid2=CMiU4b0CElxQM3JuQWk4WFFpTjhJaUtFcTRnb1JxbnFQbGVnWkN1VkdIMmZQeWRJVEhEV2lqOW1rRVM3ZzJMalI2cER3ZDZKdDdvNmZULWItaU5Lekx3UXVmc1NwX1lEQUFBfjD016foBTgNQJVO'
        self.referer = 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MjM5MTQ4NjA3Nw==&scene=124&uin=NjY2Mzg5MDY0&key=1c8d0f39d00e872318dec992d78c55e3cc4d59bd9210c96490dd65e5e61d5dda31b5d711ff280361e29027f8a85b7aa22b8b7d736710664d148b4c5a0be8693e96b300d40e17f6b2d30c97687b36b467&devicetype=Windows+10&version=62060833&lang=zh_CN&a8scene=7&pass_ticket=5Zx%2F6KSKXNBH%2BaeYBg4b7bKsVQxXIMf%2BS8GiZKBneQiu9dtMJzUuN33ddCWWtnnf&winzoom=1'
        self.headers = {
            ...
            if 1 == all_datas['can_msg_continue']:
                ...
                for data in datas:
                    try:
                        ...
                        title = '{}_{}_{}'.format(copyright, article_time, title)
                        print(title)
